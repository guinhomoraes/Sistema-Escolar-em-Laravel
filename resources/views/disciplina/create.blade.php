    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 d-flex justify-content-between 
                ...
                <h3 class="my-0"> <span class="font-weight-bold"> Disciplina </span> - Cadastrar Disciplina</h3>
            ...
            <div class="col-6">
                ...
                <form class="row" action="{{ route('disciplina.store') }}" method="post">
                    ...
                    <div class="col-12 col-md-8 col-lg-8 col-xl-8 col-xxl-8 my-2">
                        ...
                        <div class="form-group m-0">
                            ...
                            <input id="titulo" class="form-control" type="text" name="nome" 
                              value="{{ old("nome") }}">
                        </div>
