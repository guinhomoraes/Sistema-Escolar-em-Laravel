    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <form class="row" action="{{ route('turma.add-alunos') }}" method="post">
                                        ...
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($alunos as $aluno)
                                                    ...
                                                    <tr>
                                                        <td><input type="checkbox" name="Aluno[]" id="" value={{$aluno->id}}
                                                            @checked(in_array($aluno->id, $arrAlunosAdicionados))></td>
                                                        <td>{{ $aluno->name}}</td>
                                                        <td>{{ $aluno->rg}}</td>
                                                        <td>{{ $aluno->cpf}}</td>
                                                        <td>{{ $aluno->email}}</td>
                    ...
                    <div class="col-12 d-flex justify-content-center my-3">
                        <button class="btn btn-primary">Atualizar Alunos</button>
                    </div>
