    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-10">
                ...
                <form class="row" action="{{ route('turma.store') }}" method="post">
                            ...
                            <select class="form-control" name="id_professor" id="id_professor">
                                ...
                                @foreach($professores as $professor)
                                    <option value="{{$professor->id}}" 
                                            @selected( old("id_professor") == $professor->id)>{{ $professor->registro}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-12 col-lg-4 col-xl-4 col-xxl-4 my-2">
                        <div class="form-group m-0">
                            ...
                            <input class="form-control" type="text" name="nome" id="" value="{{ old('nome') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-8 col-xl-8 col-xxl-8 my-2">
                        <div class="form-group m-0">
                            ...
                            <input class="form-control" type="text" name="descricao" id="" value="{{ old('descricao') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 col-xl-4 col-xxl-4 my-2">
                        <div class="form-group m-0">
                            ...
                            <input class="form-control" type="date" name="dt_inicio" id="" value="{{ old('dt_inicio') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-4 col-xl-4 col-xxl-4 my-2">
                        <div class="form-group m-0">
                            ...
                            <input class="form-control" type="date" name="dt_termino" id="" value="{{ old('dt_termino') }}">
                        </div>
                    </div>
