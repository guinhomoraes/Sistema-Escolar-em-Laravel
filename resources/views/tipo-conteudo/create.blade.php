    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 d-flex justify-content-between 
                ...
                <h3 class="my-0"> <span class="font-weight-bold"> Tipo de Conteúdo </span> - Cadastrar Tipo de Conteúdo</h3>
            ...
            <div class="col-5">
                ...
                <form class="row" action="{{ route('tipo-conteudo.store') }}" method="post">
