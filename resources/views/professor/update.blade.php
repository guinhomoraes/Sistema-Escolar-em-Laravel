    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-10">
                ...
                <form class="row" action="{{ route('professor.update',$modelProfessor->id) }}" method="post">
                            ...
                            <select class="form-control" name="id_usuario" id="id_usuario">
                                ...
                                @foreach($usuarios as $user)
                                    <option value="{{$user->id}}" 
                                            @selected( $modelProfessor->id_usuario == $user->id)>{{ $user->name}}</option>
                                @endforeach
                            </select>
                        </div>
                            ...
                            <select class="form-control" name="id_escola" id="id_escola">
                                ...
                                @foreach($escolas as $escola)
                                    <option value="{{$escola->id}}" 
                                            @selected( $modelProfessor->id_escola == $escola->id)>{{ $escola->razao_social}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 col-xxl-4 my-2">
                         ...
                         <div class="form-group m-0">
                            ...
                            <select class="form-control" name="status" id="status">
                                <option value="0" @selected( $modelProfessor->status == 0)>Inativo</option>
                                <option value="1" @selected( $modelProfessor->status == 1)>Ativo</option>
                            </select>
                        </div>
                    ...
                    <div class="col-12">
                         ...
                         <div class="form-group my-2">
                            ...
                            <textarea class="form-control" name="observacao" id="observacao" rows="3">{{ $modelProfessor->observacao }}</textarea>
                        </div>
